% -*- coding: utf-8 -*-
% mai 2007
%mis doigtÃ©s et reportÃ© les notes en consÃ©quence main droite premiÃ¨re portÃ©e, main gauche seconde portÃ©e par \change Staff.
% simplification score-layout avec utilisation pianoStaff
% crÃ©Ã©s midialto et miditenor, le traitement midi n'acceptant pas les changements de portÃ©es
\include "italiano.ly"
\header {
  title = \markup\center-align { \fontsize #-1 \normal-text "OrgelbÃ¼chlein" "Lobt Gott, ihr Christen allzugleich" \fontsize #-2 \normal-text \italic " Un clavier, pÃ©dalier, jeux d'anches"}
  composer = "Bach"
opus = "BWV 609"
 ...
 date = "1714"
 source = "University of Rochester - FaurÃ© 1917"
 style = "Baroque"
...
global = {
%pour doigtÃ©s de changement de doigt type "4--5" :
...
{\clef treble
\global
%met doigtÃ© Ã  l'extÃ©rieur point d'orgue :
