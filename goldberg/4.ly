...
\header {
        title = "ClavierÃ¼bung Vierter Teil Aria mit 30 VerÃ¤nderungen"
...
sopranoOne =   \relative b' { \unfoldRepeats {
...
sopranoTwo =   \relative d' { \unfoldRepeats {
  \repeat volta 2 { %begin repeated section
  \stemDown
    R1*3/8 | % 1
    r8 d8 [ fis ] | % 2
...
bassOne = \relative b { \unfoldRepeats {
	\repeat volta 2 { %begin repeated section
	\stemUp
...
bassTwo = \relative c' { \unfoldRepeats {
    \repeat volta 2 { %begin repeated section
	\stemDown
    g4. | % 1
    fis4. | % 2
